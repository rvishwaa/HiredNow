...
class UserEmailVerification extends StatefulWidget {
  ...
  UserEmailVerification(this.email, this.companyId);
        ...
        body: Mutation(
            options: MutationOptions(
              document:
                  gql("""mutation sendOtp(\$type: String!,\$email:String) {
                              c_send_otp(type: \$type,email:\$email) {
                              message
                              otp_hash
                              }
                            }"""),
            ...
            builder: (
              ...
              return Mutation(
                  options: MutationOptions(
                    document: gql(
                        """mutation verifyOtp(\$otp: String!, \$otp_hash: String!, \$type: String!, \$company_id: uuid!, \$email:String) {
  c_verify_otp(otp: \$otp, otp_hash: \$otp_hash, type: \$type, company_id: \$company_id,email:\$email) {
    mobile
    type
    verified
  }
