...
class UserMobileVerification extends StatefulWidget {
  String mobileNumber;
  String userId;
  UserMobileVerification(this.mobileNumber,this.userId);
        ...
        body: Mutation(
            options: MutationOptions(
              document: gql("""mutation sendOtp(\$type: String!,\$mobile:String) {
                              send_otp(type: \$type,mobile:\$mobile) {
                              message
                              otp_hash
                              }
                            }"""),
            ...
            builder: (
              ...
              return Mutation(
                  options: MutationOptions(
                    document: gql("""mutation verifyOtp(\$otp: String!, \$otp_hash: String!, \$type: String!, \$user_id: uuid!, \$mobile:String) {
  verify_otp(otp: \$otp, otp_hash: \$otp_hash, type: \$type, user_id: \$user_id,mobile:\$mobile) {
    mobile
    type
    verified
  }
