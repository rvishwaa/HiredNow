...
mutation loginPassword(\$type: String!, \$password: String!, \$email: String,\$mobile: String) {
  c_login_password(type: \$type, password: \$password, mobile: \$mobile,email: \$email) {
    auth_token
    user_id
  }
}"""),
  ...
  c_login_otp(otp_hash: \$otp_hash, type: \$type, email: \$email, otp: \$otp,mobile:\$mobile) {
    auth_token
    user_id
  }
}"""),
                    ...
                    return Mutation(
                        options: MutationOptions(
                          document: gql(
                              ...
                              c_send_otp(type: \$type, email: \$email,mobile:\$mobile) {
                              message
                              otp_hash
                              }
                            }"""),
                          ...
                          onCompleted: (dynamic resultData3) {
                            ...
                            if(resultData3!=null){
                              setState(() {
                                otp_hash=resultData3['c_send_otp']['otp_hash'];
                              });
                            }
                          },
                        ),
